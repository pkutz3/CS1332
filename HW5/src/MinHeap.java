...
public class MinHeap<T extends Comparable<? super T>> {
    ...
    /**
     * Private method that will recursively heapify the (sub)tree of which the
     * parameter index is the root.
     *
     * @param index the index of the root of a specific (sub)tree
     */
     ...
     * capacity. It is expanded to double the original length.
     */
    private void expand() {
